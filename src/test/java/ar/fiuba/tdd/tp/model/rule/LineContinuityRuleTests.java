...
public class LineContinuityRuleTests {
    ...
    @Test
    public void testCheckCorrectCircuit1() {
        LineContinuityRule contRule = new LineContinuityRule(1);
        ArrayList<PositionValueDuo> values = new ArrayList<>();
        Boolean[] boollistIn = {false,true,false,false,true,true,false,false,false};
        Vector<Boolean> boolvecIn = new Vector<>(Arrays.asList(boollistIn));
        PositionValueDuo valueIn = new PositionValueDuo(new Value(1,boolvecIn),new Position(1,1));
        contRule.check(values,valueIn);
        values.add(valueIn);
        Boolean[] boollist0 = {false,false,false,false,true,true,false,true,false};
        ...
        values.add(value0);
        Boolean[] boollist1 = {false,true,false,true,true,false,false,false,false};
        Vector<Boolean> boolvec1 = new Vector<>(Arrays.asList(boollist1));
        PositionValueDuo value1 = new PositionValueDuo(new Value(2,boolvec1),new Position(2,1));
        values.add(value1);

        //Vector<Value> valuesNext = contRule.getTransversalValues(values,valueIn);
        //assertTrue(value0.getValue().areDotsEqualTo(valuesNext.elementAt(0)));
        assertTrue(contRule.checkFinal(values));
    }

    @Test
    public void testCheckCorrectCircuit2() {
        LineContinuityRule contRule = new LineContinuityRule(1);
        ArrayList<PositionValueDuo> values = new ArrayList<>();
        Boolean[] boollistIn = {true,true,true,false,false,false,false,false,false};
        Vector<Boolean> boolvecIn = new Vector<>(Arrays.asList(boollistIn));
        PositionValueDuo valueIn = new PositionValueDuo(new Value(0,boolvecIn),new Position(3,4));
        contRule.check(values,valueIn);
        values.add(valueIn);
        Boolean[] boollist0 = {true,false,false,true,false,false,true,false,false};
        Vector<Boolean> boolvec0 = new Vector<>(Arrays.asList(boollist0));
        PositionValueDuo value0 = new PositionValueDuo(new Value(0,boolvec0),new Position(3,5));
        values.add(value0);
        Boolean[] boollist1 = {true,true,true,false,false,false,false,false,false};
        Vector<Boolean> boolvec1 = new Vector<>(Arrays.asList(boollist1));
        PositionValueDuo value1 = new PositionValueDuo(new Value(1,boolvec1),new Position(4,4));
        values.add(value1);
        assertTrue(contRule.checkFinal(values));
    }

    @Test
    public void testCheckCorrectCircuit3() {
        LineContinuityRule contRule = new LineContinuityRule(1);
        ArrayList<PositionValueDuo> values = new ArrayList<>();
        ...
        PositionValueDuo value3 = new PositionValueDuo(new Value(3,boolvec3),new Position(0,1));
        values.add(value3);
        Boolean[] boollist2 = {true,true,true,false,false,false,false,false,false};
        Vector<Boolean> boolvec2 = new Vector<>(Arrays.asList(boollist2));
        PositionValueDuo value2 = new PositionValueDuo(new Value(2,boolvec2),new Position(1,0));
        values.add(value2);
        //Vector<Value> valuesNext = contRule.getTransversalValues(values,valueIn);
        //assertTrue(value3.getValue().areDotsEqualTo(valuesNext.elementAt(3)));
        assertTrue(contRule.checkFinal(values));
    }
    ...
    public void testCheckIncorrectCircuit() {
        ...
        Vector<Boolean> boolvec3 = new Vector<>(Arrays.asList(boollist3));
        PositionValueDuo value3 = new PositionValueDuo(new Value(0,boolvec3),new Position(1,0));
        values.add(value3);
        ...
        PositionValueDuo value4 = new PositionValueDuo(new Value(0,boolvec4),new Position(0,1));
        values.add(value4);
    ...
    public void testCheckIncorrectCircuit2() {
        ...
        Boolean[] boollist2 = {true,true,true,false,false,false,false,false,false};
        Vector<Boolean> boolvec2 = new Vector<>(Arrays.asList(boollist2));
        PositionValueDuo value2 = new PositionValueDuo(new Value(1,boolvec2),new Position(3,3));
        values.add(value2);
        assertFalse(contRule.checkFinal(values));
    }
    ...
    public void testTransversalValues() {
        ...
        PositionValueDuo value0 = new PositionValueDuo(new Value(1,boolvec),new Position(1,2));
        values.add(value0);
        PositionValueDuo value2 = new PositionValueDuo(new Value(3,boolvec),new Position(1,0));
        values.add(value2);
        PositionValueDuo value3 = new PositionValueDuo(new Value(4,boolvec),new Position(0,1));
        PositionValueDuo value1 = new PositionValueDuo(new Value(2,boolvec),new Position(2,1));
        values.add(value1);
        values.add(value3);
        Vector<Value> valuesNext = contRule.getTransversalValues(values,valueIn);
