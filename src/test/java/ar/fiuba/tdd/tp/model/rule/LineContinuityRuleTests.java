...
public class LineContinuityRuleTests {
    ...
    public void testCheckCorrectCircuit1() {
        ...
        Vector<Boolean> boolvec1 = new Vector<>(Arrays.asList(boollist1));
        PositionValueDuo value1 = new PositionValueDuo(new Value(2,boolvec1),new Position(1,2));
        values.add(value1);
    ...
    public void testCheckCorrectCircuit2() {
        ...
        Boolean[] boollist1 = {true,true,true,false,false,false,false,false,false};
        Vector<Boolean> boolvec1 = new Vector<>(Arrays.asList(boollist1));
        PositionValueDuo value1 = new PositionValueDuo(new Value(1,boolvec1),new Position(1,2));
        values.add(value1);
        assertTrue(contRule.checkFinal(values));
    }
    ...
    public void testCheckCorrectCircuit3() {
        ...
        PositionValueDuo value3 = new PositionValueDuo(new Value(3,boolvec3),new Position(1,0));
        values.add(value3);
        Boolean[] boollist2 = {true,true,true,false,false,false,false,false,false};
        Vector<Boolean> boolvec2 = new Vector<>(Arrays.asList(boollist2));
        PositionValueDuo value2 = new PositionValueDuo(new Value(2,boolvec2),new Position(2,1));
        values.add(value2);
        //Vector<Value> valuesNext = contRule.getTransversalValues(values,valueIn);
