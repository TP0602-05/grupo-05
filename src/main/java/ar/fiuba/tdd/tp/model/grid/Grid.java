package ar.fiuba.tdd.tp.model.grid;
...
import ar.fiuba.tdd.tp.model.rule.lines.AmountOfLinesRule;
import ar.fiuba.tdd.tp.model.rule.math.MultiplicationRule;
...
public class Grid {
    ...
    public boolean setCell(Value value, int row, int col) {
