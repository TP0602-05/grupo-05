...
public class ButtonHashing {
    ...
    void putVectorOne() {
        ...
        map.put(10,new Value(-1,boolvec2));
    }
    ...
    void putVectorTwo() {
        ...
        map.put(11,new Value(-1,boolvec3));
    }
    ...
    void putVectorThree() {
        ...
        map.put(12,new Value(-1,boolvec4));
    }
    ...
    void putVectorFour() {
        ...
        map.put(13,new Value(-1,boolvec5));
    }
    ...
    void putVectorFive() {
        ...
        map.put(14,new Value(-1,boolvec6));
    }
    ...
    void putVectorSix() {
        ...
        map.put(15,new Value(-1,boolvec7));
    }
    ...
    void putVectorSeven() {
        ...
        map.put(16,new Value(-1,boolvec8));
    }
    ...
    void putVectorEight() {
        ...
        map.put(17,new Value(-1,boolvec9));
    }
    ...
    void putVectorNine() {
        ...
        map.put(18,new Value(-1,boolvec10));
    }
    ...
    void putVectorTen() {
        ...
        map.put(19,new Value(-1,boolvec11));
    }
    ...
    void putVectorEleven() {
        ...
        map.put(20,new Value(-1,boolvec12));
    }
    ...
    void putVectorTwelve() {
        ...
        map.put(21,new Value(-1,boolvec13));
    }
    ...
    void putVectorThirteen() {
        ...
        map.put(22,new Value(-1,boolvec14));
    }
